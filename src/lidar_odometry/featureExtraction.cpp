...
public:
    ...
    : ParamServer("lvi_sam_featureExtraction", options)
    {
        ...
        pubCornerPoints = this->create_publisher<sensor_msgs::msg::PointCloud2>(
            PROJECT_NAME + "/lidar/feature/cloud_corner", qos());
        pubSurfacePoints = this->create_publisher<sensor_msgs::msg::PointCloud2>(
            PROJECT_NAME + "/lidar/feature/cloud_surface", qos());
...
int main(int argc, char** argv)
{
    ...
    auto featureExtraction = std::make_shared<FeatureExtraction>(options);

    RCLCPP_INFO(featureExtraction->get_logger(), "\033[1;32m----> Lidar Feature Extraction Started.\033[0m");
   
    rclcpp::spin(featureExtraction);
...
RCLCPP_COMPONENTS_REGISTER_NODE(FeatureExtraction)