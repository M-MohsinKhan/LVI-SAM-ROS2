...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            {
                RCLCPP_WARN(rclcpp::get_logger("imu_factor"), "numerical unstable in preintegrationj");
            ...
            jacobian_pose_i.block<3, 3>(O_R, O_R) = -(Qj.inverse() * Qi).toRotationMatrix();
                ...
                {
                    RCLCPP_WARN(rclcpp::get_logger("imu_factor"), "numerical unstable in preintegrationj0");
                     RCLCPP_WARN(rclcpp::get_logger("imu_factor"), 
                            "numerical unstable: max_coeff=%f, sum_dt=%f, P_diff=%f, V_diff=%f",
                            jacobian_pose_i.maxCoeff(), sum_dt, 
                            (Pj - Pi).norm(), (Vj - Vi).norm());
