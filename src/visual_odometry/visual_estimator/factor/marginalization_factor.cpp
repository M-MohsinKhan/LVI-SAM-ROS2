...
void MarginalizationInfo::marginalize()
{
    ...
    // marginalization, pos: %d, m: %d, n: %d, size: %d
    ...
    */
    ...
    // assert_msg(saes.eigenvalues().minCoeff() >= -1e-4, "min eigenvalue %f", saes.eigenvalues().minCoeff());
